-- Add SECURITY DEFINER to get_nearby_shops function
-- This allows the function to bypass RLS policies and access all approved shops
...
GRANT EXECUTE ON FUNCTION get_nearby_shops(DECIMAL, DECIMAL, DECIMAL) TO authenticated;
GRANT EXECUTE ON FUNCTION get_nearby_shops(DECIMAL, DECIMAL, DECIMAL) TO anon;